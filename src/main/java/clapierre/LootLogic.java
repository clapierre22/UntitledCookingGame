...
//		HashMap to hold all objects with the type and rarity hashed
	...
	private void setup() {	
		possibleItems.put(0, new ArrayList<>(Arrays.asList(new Loonie(1, 1), new Toonie(1, 1), new GreenTea(1, 1), new Harold(1, 1))));
		possibleItems.put(1, new ArrayList<>(Arrays.asList(new Baguette(1, 1), new Donut(1, 1), new ApplePie(1, 1), new Tiramisu(1, 1))));   
		possibleItems.put(2, new ArrayList<>(Arrays.asList(new SharpenedWoodenSpoon(1, 1), new SilverSpoon(1, 1), new KitchenKnife(1, 1), new FryingPan(1, 1))));
	}
